  ...
  return (
    <section className='terms'>
      <div className='terms__row'>
        <h1 className='terms__title'>{location.pathname === '/terms' ? 'Правила пользования' : 'Договор оферты'}</h1>
        <div className='terms__content'>
          ...
          <div className='subparagraph'>
            <p>
              ...
              <div className='subparagraph__item'>
                <p>
          ...
          <div className='subparagraph'>
            ...
            <div className='subparagraph__item'>
              ...
              <p className='subparagraph__sub-item'>
